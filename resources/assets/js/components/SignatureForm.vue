<template>
    <div>
        <div class="alert alert-success" v-if="saved">
            <strong>Success!</strong> Assinatura salva com sucesso.
        </div>

        <div class="well well-sm" id="signature-form">
            <form class="form-horizontal" method="post" @submit.prevent="onSubmit">
                <fieldset>
                    <legend class="text-center">Assinar o livro de visitas</legend>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="body">Mensagem</label>
